...
const layers = [
  {
    ...
    label: "Steel Frame",
    color: "var(--electric)",
    desc: "Welded mild-steel chassis. Load-bearing structure carrying every other system.",
  },
  {
    id: "mech",
    label: "Mechanical",
    color: "var(--electric)",
    desc: "Lead screws, linear rails, stepper-driven gantry — converts torque to motion.",
  },
  {
    id: "elec",
    label: "Electronics",
    color: "var(--electric)",
    desc: "Custom controller board, drivers and sensors orchestrating every axis.",
  },
  {
    id: "housing",
    label: "Housing & Finish",
    color: "var(--electric)",
    desc: "Brushed steel panels, viewport glass and electric-blue accent lighting.",
  },
];
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            Disassemble a <span className="text-electric">machine.</span>
          </>
        }
        ...
        <div className="grid gap-10 md:grid-cols-12">
          ...
          <div className="md:col-span-8">
            <div className="relative aspect-[4/3] overflow-hidden rounded-sm hairline-top hairline-bottom blueprint-grid bg-surface/40">
              ...
              {/* Scan line */}
              <div
                className="absolute inset-x-0 top-9 h-px scan-x bg-gradient-to-r from-transparent via-electric to-transparent"
                aria-hidden
              />
                    ...
                    <div className="relative h-[58%] w-[68%]">
                      ...
                      <div className="absolute inset-0 overflow-hidden rounded-sm border border-electric/30 bg-background/80 shadow-2xl backdrop-blur-sm">
                        ...
                        {i === layers.length - 1 ? (
                          ...
                          <svg
                            viewBox="0 0 400 260"
                            className="h-full w-full text-electric"
                            fill="none"
                            stroke="currentColor"
                            strokeWidth="0.7"
                          >
            ...
            <div className="mt-6 rounded-sm border border-hairline bg-surface/40 p-5">
              ...
              <div className="mt-3">
                <Slider
                  value={[spread]}
                  onValueChange={(v) => setSpread(v[0] ?? 0)}
                  min={0}
                  max={100}
                  step={1}
                />
          ...
          <aside className="md:col-span-4">
            ...
            <ul className="mt-6 space-y-px bg-hairline/40">
              {layers.map((l, i) => (
                <li
                  key={l.id}
                  className="bg-surface/60 p-4 transition-colors hover:bg-surface-elevated"
                >
