...
export default function ContactPage() {
  const [intent, setIntent] = useState<string>("commission");
  ...
  return (
    <>
      <PageHero
        ...
        title={
          <>
            Bring your vision <span className="text-electric">to steel.</span>
          </>
        }
            ...
            {submitted ? (
              <div className="relative overflow-hidden rounded-sm border border-electric/40 bg-electric/5 p-10">
                ...
                <p className="mt-3 max-w-md text-sm text-muted-foreground">
                  The foundry will reply from Addis Ababa within 48 hours. Keep an eye on your inbox
              ...
              <form
                onSubmit={onSubmit}
                className="space-y-8 rounded-sm border border-hairline bg-surface/40 p-6 sm:p-8"
              >
                <div>
                ...
                <div className="flex flex-col items-start gap-3 hairline-top pt-6 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  >
                    Transmit
                    <span className="transition-transform ease-mech group-hover:translate-x-1">
                      →
                    </span>
                  </button>
                </div>
          ...
          <aside className="md:col-span-5 space-y-6">
            ...
            <div className="rounded-sm border border-hairline bg-surface/40 p-6">
              ...
              <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
                <li className="flex gap-3">
                  <span className="mt-2 h-px w-4 bg-electric/60 shrink-0" /> Reply from a real
                  engineer, not a bot.
                </li>
                <li className="flex gap-3">
                  <span className="mt-2 h-px w-4 bg-electric/60 shrink-0" /> A first technical
                  opinion within 48 hours.
                </li>
                <li className="flex gap-3">
                  <span className="mt-2 h-px w-4 bg-electric/60 shrink-0" /> Confidentiality on
            ...
            <div className="rounded-sm border border-electric/30 bg-electric/5 p-6">
              ...
              <p className="mt-2 text-sm text-muted-foreground">
                The software engineering studio behind this portfolio — building the digital layer
                of African industry.
              </p>
            </div>
          </aside>
