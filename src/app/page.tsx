...
const teasers = [
  {
    href: "/inventions",
    num: "02",
    label: "Museum of Triumphs",
    desc: "Award-winning machines, exploded into their making.",
    img: cncImg,
  },
  {
    href: "/blueprint",
    num: "03",
    label: "Virtual Blueprint",
    desc: "Disassemble a machine layer by layer.",
    img: pressImg,
  },
  {
    href: "/services",
    num: "04",
    label: "B2B Foundry",
    desc: "Custom design · fabrication · prototyping.",
    img: welderImg,
  },
  {
    href: "/investors",
    ...
    desc: "Roadmap for the African industrial revolution.",
    img: workshopImg,
  },
];
        ...
        <div className="relative mx-auto flex min-h-[calc(100svh-6rem)] max-w-7xl flex-col justify-end px-4 pb-20 sm:px-6 lg:px-8">
          <div className="max-w-4xl rise">
            ...
            <p className="mt-8 max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg">
              An Addis Ababa foundry where a multi-award-winning inventor&apos;s vision becomes
              industrial-scale machinery — the bridge between raw mechanical innovation and the
              manufacturing of a continent.
            </p>
        ...
        <div className="grid gap-12 md:grid-cols-12">
          <div className="md:col-span-5">
            <SectionHeader
              ...
              title={
                <>
                  From science fairs to <span className="text-electric">industrial scale.</span>
                </>
              }
            />
          </div>
          <div className="md:col-span-7 space-y-6 text-base leading-relaxed text-muted-foreground sm:text-lg">
            <p>
              Habtamu Demse is a multi-award-winning Ethiopian inventor who turned a prodigy&apos;s
              notebook into an operational foundry. ETH HD Metal Work designs and fabricates the
              machines that other industries
              <span className="text-foreground"> need to exist</span> — agricultural processors,
              fabrication tools, custom machinery for clients who would otherwise import.
            </p>
            <p>
              Engineered by <span className="text-electric">Coding4Ethiopia</span>, this site is the
              high-tech bridge between raw mechanical innovation and industrial-scale manufacturing.
            </p>
          </div>
        </div>
      </section>
            ...
            >
              ...
              <div className="relative flex min-h-[260px] flex-col justify-between">
                <div className="flex items-center justify-between font-mono text-[10px] uppercase tracking-[0.3em]">
                  ...
                  <span className="text-muted-foreground transition-transform ease-mech group-hover:translate-x-1">
                    →
                  </span>
                </div>
                <div>
