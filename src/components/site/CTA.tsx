...
export function CTA() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-x-0 top-1/2 -translate-y-1/2 h-64 bg-electric/10 blur-3xl" aria-hidden />
      <div className="relative mx-auto max-w-5xl px-4 py-24 text-center sm:px-6 sm:py-32">
        ...
        <p className="mx-auto mt-6 max-w-xl text-base leading-relaxed text-muted-foreground sm:text-lg">
          From prototype to industrial run — partner with the Ethiopian foundry
          engineering Africa's next century of machinery.
        </p>
